...
// This is the Post http method use this to check on postman http://localhost:5000/Employees use this to create a new employee data
records.post('/Employees', (req, res) => {
...
// This is the http Put method use this on POSTMAN http://localhost:5000/Employees/1 to update the information of an  employee
...
// This the http Method "DELETE" http://localhost:5000/Employees/10 i used this to delete an employee's data.
